...
class SpotBugsAnnotationProviderTest extends Specification {
    ...
    def 'check'() {
        ...
        sut.convert() == [
            ...
            new Annotation(7, 'new io.jenkins.plugins.codeInsights.infrastructure.FileTransferServiceImpl(FilePath, Run) は，FileTransferServiceImpl.workspace の中に外部の可変オブジェクトを格納することによって内部表現を暴露するかもしれません。', 'src/main/java/io/jenkins/plugins/codeInsights/framework/FileTransferServiceImpl.kt', Severity.LOW, null),
